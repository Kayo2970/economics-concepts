...
3. **Git commit and push** — stage all changes, commit with a descriptive message, and push to origin

Do this every single time without being asked. Never skip this step.
